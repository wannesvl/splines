...
\begin{tabular}{c}
\textsc{\Large Spline optimization}\\[12pt]
\parbox{12cm}{

\textbf{What?}
\begin{itemize}\vspace*{-6pt} \itemsep 0pt
\item optimization problems with tensor-product spline variables 
\item semi-infinite constraints are relaxed to constraints on the spline coefficients
\end{itemize}
...
\item extension to simplicial splines and non-hyperrectangular domains
\end{itemize}
